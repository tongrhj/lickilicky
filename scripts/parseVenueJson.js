...
const fs = require('fs');
const data = JSON.parse(fs.readFileSync('historical_data/venues_23Aug2018.json'));
const existingData = JSON.parse(fs.readFileSync('historical_data/parsed_data/parsed_venues_21Aug2018.min.json'));
...
fs.writeFile('historical_data/parsed_data/parsed_venues_23Aug2018.min.json', minData, (err) => {
  if (err) throw err;
