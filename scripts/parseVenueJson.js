...
const fs = require('fs');
const data = JSON.parse(fs.readFileSync('historical_data/venues_14Aug2018.json'));
const existingData = JSON.parse(fs.readFileSync('historical_data/parsed_data/parsed_venues_13Aug2018_3.min.json'));
...
fs.writeFile('historical_data/parsed_data/parsed_venues_14Aug2018.min.json', minData, (err) => {
  if (err) throw err;
